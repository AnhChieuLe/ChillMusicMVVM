...
class FragmentBottomPlayList : BottomSheetDialogFragment(){
    ...
    private val args: FragmentBottomPlayListArgs by navArgs()
    private val adapter: PlayListAdapter by lazy {
        PlayListAdapter(viewModel)
    }

    companion object {
        fun newInstance(id: Long): FragmentBottomPlayList{
            val args = Bundle()
            args.putLong("id", id)
            val fragment = FragmentBottomPlayList()
